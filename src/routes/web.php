...
Route::group(['prefix' => __config('routes.prefixes.dashboard')], function () {
...
Route::group(['prefix' => __config('routes.prefixes.tests')], function () {
...
Route::group(['prefix' => __config('routes.prefixes.projects')], function () {
...
Route::group(['prefix' => __config('routes.prefixes.files')], function () {
